...
function createPresignedUrl() {
    ...
    // Medical Transcribe uses the "/medical-transcription-websocket" endpoint and adds "+ "&specialty=PRIMARYCARE&type=DICTATION"" to the query
    // Transcribe uses the "/stream-transcription-websocket" endpoint
